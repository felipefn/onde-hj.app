...
import '../modules/auth/domain/entities/email_login_request_entity.dart';
import '../modules/auth/domain/entities/get_user_data_request_entity.dart';
import '../modules/auth/domain/entities/login_user_entity.dart';
import '../modules/auth/domain/entities/user_data_entity.dart';
import '../modules/auth/domain/usecases/renew_user_auth_token_usecase.dart';
import '../modules/auth/presenter/stores/auth_store.dart';
import 'failure.dart';
import 'main_client_interface.dart';

class IngresseAuthenticator {
  ...
  IngresseAuthenticator(this._client, this.eventBus, this.router);
